...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is ShareManager
                   DESC

  s.homepage     = "https://github.com/Limghi/ShareManager.git"
  ...
  s.source       = { :git => "https://github.com/Limghi/ShareManager.git", :tag => s.version.to_s }
